...
export default function EmojiBurst(props: MobileHapticsProps) {
        ...
        if (obj && typeof obj.animate === "function") {
            ...
            obj.animate(
                [
                    ...
                    { transform: `scale(1) translate(${s}px, ${-s * 0.6}px) rotate(-2.5deg)` },
                    { transform: `scale(1) translate(${-s}px, ${s * 0.3}px) rotate(2.5deg)` },
                    { transform: `scale(1) translate(${s * 0.5}px, 0px) rotate(-1deg)` },
