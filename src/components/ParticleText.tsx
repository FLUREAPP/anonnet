...
function __OriginkitBase_ParticleText(props: Props) {
    ...
    useEffect(() => {
        ...
        const sampleText = () => {
            ...
            const pCount = Math.max(1, Math.min(150, particleCount))
    ...
    return (
        <div
            ...
            style={{
                ...
                minWidth: 80, // adjusted down for smaller usage
                minHeight: 30, // adjusted down
                overflow: "hidden",
                ...style,
            }}
        >
...
export default function ParticleText(props: Partial<Props>) {
  return <__OriginkitBase_ParticleText {...(__originkitPresetProps as unknown as Props)} {...(props as unknown as Props)} />;
}
