...
const DEFAULT_FONT: FontStyle = {
  ...
  fontWeight: 700,
  fontSize: "26px", // Dikecilin agar pas dan proporsional di header
...
// EFEK WARNA ICE-BLUE & SILVER HOLOGRAPHIC (Clean, Premium, Tidak Norak)
...
const CharBox = memo(
  ({ char, rotateDirection }: CharBoxProps) => (
    <span
...
const __originkitPresetProps = {
  ...
  "font": {
    "variant": "Bold",
    "fontSize": "26px", // Disesuaikan agar pas di atas kotak chat
    "textAlign": "center",
    "fontFamily": "'Orbitron', sans-serif",
    "fontWeight": 700,
    "lineHeight": "1em",
